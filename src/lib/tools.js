...
export const TOOLS = [
    // ── FORMATTING CATEGORY ──────────────────────────────────────────────
    {
        ...
        category: 'formatting',
        desc: 'Fix smart quotes, em dashes, double spaces, and encoding errors from Word or Google Docs exports. Formats your manuscript for Kindle KDP or EPUB instantly.',
        type: 'logic',
        accessType: 'logic',
        creditCost: 0,
        free: false,
    ...
    },
    {
        ...
        name: 'TOC Generator',
        category: 'formatting',
        desc: 'Build a clickable, correctly formatted Table of Contents for Kindle, EPUB3, and NCX. Paste your chapter headings and get clean, publish-ready TOC code in seconds.',
        type: 'logic',
        accessType: 'logic',
        creditCost: 0,
        free: false,
    ...
    },
    {
        ...
        category: 'formatting',
        desc: 'AI-powered manuscript cleanup that catches dialogue punctuation errors, repeated words, and clichés that basic spell checkers always miss. Works for fiction and non-fiction.',
        type: 'ai',
        accessType: 'ai',
        creditCost: 3,
        free: false,
    ...
    },
    {
        ...
        category: 'formatting',
        desc: 'Convert print-specific elements like page references, footnotes, and running headers into eBook-ready format using AI. Works for KDP and EPUB in minutes.',
        type: 'ai',
        accessType: 'ai',
        creditCost: 3,
        free: false,
    ...
    // ── STRUCTURE CATEGORY ──────────────────────────────────────────────
    {
        ...
        category: 'structure',
        desc: 'Generate a professional title page, copyright page, dedication, and disclaimer for your book. Fill out a simple form and get publish-ready front matter instantly.',
        type: 'logic',
        accessType: 'logic',
        creditCost: 0,
        free: false,
    ...
    },
    {
        ...
        category: 'structure',
        desc: 'AI writes your author bio, mailing list call-to-action, Also By section, and closing note. Professional back matter for indie authors done in minutes.',
        type: 'ai',
        accessType: 'ai',
        creditCost: 2,
        free: false,
    ...
    },
    {
        ...
        category: 'structure',
        desc: 'Get copy-paste CSS for drop caps, scene breaks, blockquotes, pull quotes, and more. Live preview included. Optimized for Kindle KFX and EPUB stylesheets.',
        type: 'logic',
        accessType: 'logic',
        creditCost: 0,
        free: false,
    ...
    // ── QUALITY CATEGORY ──────────────────────────────────────────────
    {
        ...
        name: 'EPUB Validator',
        category: 'quality',
        desc: 'Check your EPUB file for errors before uploading to KDP or IngramSpark. No Java required. Catches structure and content issues instantly. Free, no signup needed.',
        type: 'logic',
        accessType: 'free',
        creditCost: 0,
        free: true,
    ...
    },
    {
        ...
        category: 'quality',
        desc: 'AI scans your manuscript for style inconsistencies — character names, capitalisation, hyphenation, dialogue punctuation — that human editors charge hundreds to catch.',
        type: 'ai',
        accessType: 'ai',
        creditCost: 3,
        free: false,
    ...
    // ── PUBLISHING CATEGORY ──────────────────────────────────────────────
    {
        ...
        category: 'publishing',
        desc: 'Build complete book metadata formatted for KDP, IngramSpark, Draft2Digital, and EPUB OPF files. Free tool for indie authors. No account required.',
        type: 'logic',
        accessType: 'free',
        creditCost: 0,
        free: true,
    ...
    },
    {
        ...
        category: 'publishing',
        desc: 'Generate long-tail KDP keywords and full Amazon category paths for your book using AI. Improve your discoverability and reach more readers on Amazon.',
        type: 'ai',
        accessType: 'ai',
        creditCost: 1,
        free: false,
