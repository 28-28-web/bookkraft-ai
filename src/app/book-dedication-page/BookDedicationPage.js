  ...
  return (
    <main style={{ maxWidth: 880, margin: '0 auto', padding: '64px 20px', color: 'var(--ink, #1a1a1a)' }}>
      ...
      <div style={{ padding: '28px 24px', border: '1px solid rgba(201,168,76,0.3)', borderRadius: 12, textAlign: 'center', marginTop: 40 }}>
        <p style={{ fontSize: 18, marginBottom: 8, fontWeight: 600 }}>Format your full book — dedication included — as EPUB 3.</p>
        <p style={{ fontSize: 15, opacity: 0.75, marginBottom: 20 }}>Full Manuscript Mode converts your .docx or .txt to a valid EPUB 3. Chapters detected automatically, smart quotes and em dashes cleaned. Free — no signup required.</p>
        <Link
