  ...
  return (
    <main style={{ maxWidth: 880, margin: '0 auto', padding: '64px 20px', color: 'var(--ink, #1a1a1a)' }}>
      ...
      <div style={{ padding: '28px 24px', border: '1px solid rgba(201,168,76,0.3)', borderRadius: 12, textAlign: 'center', marginTop: 40 }}>
        <p style={{ fontSize: 18, marginBottom: 8, fontWeight: 600 }}>Convert your manuscript — front matter included — to EPUB 3.</p>
        <p style={{ fontSize: 15, opacity: 0.75, marginBottom: 20 }}>Full Manuscript Mode accepts .docx or .txt, detects chapters automatically, and outputs a valid EPUB 3 ready for KDP and Apple Books. Free — no signup required.</p>
        <Link
