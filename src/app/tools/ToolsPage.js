...
const TOOLS = [
  {
    slug: 'epub-formatter',
    name: 'EPUB Formatter',
    desc: 'Paste your manuscript with inline image references (![alt](filename.jpg)) — upload the images once and they\'re embedded exactly where you placed them. Generates EPUB 3 with chapters, metadata, and cover.',
