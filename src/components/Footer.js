                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                    <div>
                        ...
                        <div style={{ display: 'flex', gap: '16px' }}>
                            <a href="https://x.com/bookkraftai" target="_blank" rel="noopener noreferrer" aria-label="X" style={{ color: '#7a7068' }}>
                            ...
                            <a href="https://www.linkedin.com/company/bookkraftai" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{ color: '#7a7068' }}>
