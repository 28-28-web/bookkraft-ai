            ...
            <div className="footer-grid">
                <div>
                    ...
                    <div style={{ display: 'flex', gap: 'var(--space-4)', marginTop: 'var(--space-4)' }}>
                        <a href="https://twitter.com/bookkraftai" target="_blank" rel="noopener noreferrer"
                            style={{ color: 'var(--mid)', fontSize: 'var(--text-sm)' }} aria-label="Twitter">
                        ...
                        <a href="https://www.facebook.com/bookkraftai" target="_blank" rel="noopener noreferrer"
                            style={{ color: 'var(--mid)', fontSize: 'var(--text-sm)' }} aria-label="Facebook">
